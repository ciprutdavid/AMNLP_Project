...
import project.finetuning.hf_pretrained_t5_encoder_with_qass as HF_Splinter
...
if __name__ == "__main__":
    ...
    for seed, examples in settings:
        ...
        model = HF_Splinter.HFSplinterT5Model()

        args = {
            # output setting
            'output_dir': f"output_dir/hf_pretrained_encoder_finetune_{seed}_{examples}/",
